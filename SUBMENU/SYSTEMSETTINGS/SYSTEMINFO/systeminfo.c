...
static void load_system_info(void)
{
    ...
    if (fd >= 0)
    {
        ...
        if (len >= 14)
        {
            ...
            if      (!strcmp(ver, "0100") || !strcmp(ver, "0101")) strcpy(model_str, "Model: SCPH-10000 / 15000");
            else if (!strcmp(ver, "0110")) strcpy(model_str, "Model: SCPH-18000");
            else if (!strcmp(ver, "0120")) strcpy(model_str, "Model: SCPH-3000x");
            else if (!strcmp(ver, "0150")) strcpy(model_str, "Model: SCPH-3000xR / 3500xR");
            else if (!strcmp(ver, "0160")) strcpy(model_str, "Model: SCPH-3500x / 3700x / 3900x");
            else if (!strcmp(ver, "0170")) strcpy(model_str, "Model: SCPH-500xx");
            else if (!strcmp(ver, "0190")) strcpy(model_str, "Model: SCPH-700xx");
            else if (!strcmp(ver, "0210")) strcpy(model_str, "Model: SCPH-7500x / 7700x / 7900x");
            else if (!strcmp(ver, "0220")) strcpy(model_str, "Model: SCPH-7500x / 7700x / 7900x");
            else if (!strcmp(ver, "0230")) strcpy(model_str, "Model: SCPH-9000x / SCPH-500xx late / PStwo (v15)");
            else                           strcpy(model_str, "Model: Unknown / Custom / MechaPwn");
        }
    }

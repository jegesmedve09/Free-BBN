...
void menu_show(void){while (1){
	...
	font_draw_text("FREE-BBN", 5, 5, GS_SETREG_RGBAQ(0x00, 0x00, 0x00, 0x00, 0x00), 5, 4);
	font_draw_text("ALPHA", 100, 15, GS_SETREG_RGBAQ(0x00, 0x00, 0x00, 0x00, 0x00), 2, 2);
	font_draw_text("Menu", 560, 5, GS_SETREG_RGBAQ(0x00, 0x00, 0x00, 0x00, 0x00), 5, 4);
	for (int i = 0; i < MENU_ITEM_COUNT; i++)
	{
		...
		if (i == MENU_ITEM)
		{
			font_draw_text(menu_items[i], 20, y, GS_SETREG_RGBAQ(0xFF, 0xFF, 0x00, 0x00, 0x00), 5, 4);
		}
		else
		{
			font_draw_text(menu_items[i], 20, y, GS_SETREG_RGBAQ(0x00, 0x00, 0x00, 0x00, 0x00), 5, 4);
		}
	}
